                    ...
                    <div class="w-full mx-auto p-8 rounded-3xl shadow-lg bg-neutral-900 text-white">
                        ...
                        <form action="#" method="POST" class="space-y-6">
                            ...
                            <div
                                ...
                                <button type="button"
                                    class="w-full sm:w-1/2 flex justify-center py-3 px-4 focus:border transition-colors duration-300 rounded-md shadow-sm text-sm font-medium text-emerald-500 bg-neutral-800 hover:bg-neutral-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neutral-600">
                                    Ganti Password
                                </button>
                            </div>
                        </form>
