...
<body class="bg-black">
    ...
    <section class="hero relative min-h-screen px-4 flex items-center justify-center md:w-full w-10/12 mx-auto overflow-hidden ">
        ...
        <div class="w-full justify-center flex flex-col items-center max-w-2xl  mx-auto py-36 md:py-72 ">
            ...
            <div class="flex flex-col md:flex-row w-full gap-5 mx-auto items-center justify-center pt-10 ">
                ...
                <a href="daftarcosplay.php" class="w-full md:w-1/2">
                    <button
    ...
    <div class="flex justify-center items-center">
        ...
        <section class="timeline flex flex-col justify-center w-10/12 md:w-full mx-auto ">
            ...
            <img src="./img/Submission/timelinecosplay.png" alt=""
                class="hidden sm:block w-10/12 justify-center mx-auto">
            <img src="./img/Submission/timelinecosplay.png" alt="" class="block sm:hidden w-full">
        </section>
    </div>
    <br><br><br><br><br><br><br><br>
