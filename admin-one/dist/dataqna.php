...
<head>
    ...
    <title>Dashboard - Data QnA</title>
...
<body>
    ...
    <div id="app">
        ...
        <section class="section main-section">
            ...
            <p>Add Q&A and click this button</p>
            <div class="field">
                <div class="control">
                    <a class="button blue" href="index.php">Back</a>
                    <a class="button blue" href="addqna.php">
            ...
            <div class="card has-table">
                <div class="card-content">
                    ...
                    // Query untuk mengambil data qna dengan pagination
    ...
    LIMIT ?, ?";
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            // Tampilkan jawaban, dengan memotong jika terlalu panjang
                            $jawaban = htmlspecialchars($row['jawaban']);
                            $jawaban_short = strlen($jawaban) > 50 ? substr($jawaban, 0, 50) . '...' : $jawaban;

                            echo '<td>';
                            echo '<span class="short-answer">' . $jawaban_short . '</span>';

                            // Tampilkan tombol "(see more)" untuk jawaban lengkap
                            if (strlen($jawaban) > 50) {
                                echo '<span class="full-answer" style="display: none;">' . $jawaban . '</span>';
                                echo '<br><button class="see-more-button text-red-500 font-semibold" onclick="showFullAnswer(this)">See more</button>';
                            }
                            ...
                            // Tampilkan aksi (hapus dan lihat detail)
                            echo '<td class="actions-cell">';
                            echo '<div class="buttons right nowrap">';
                            echo '<a class="button small red --jb-modal" onclick="confirmDelete(' . $row['id'] . ')">';
                        ...
                        // Hitung total data
                        $count_query = "SELECT COUNT(*) AS total FROM qna";
        ...
        <script>
            function confirmDelete(id) {
                if (confirm('Are you sure you want to delete this item?')) {
                    window.location.href = 'delete_qna.php?id=' + id;
                }
            }
        </script>
