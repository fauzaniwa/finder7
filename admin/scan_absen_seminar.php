...
<head>
    ...
    <title>Scan Absen Seminar/Workshop</title>
...
<body class="bg-gray-900 text-white flex flex-col items-center justify-center h-screen p-4">
    ...
    <div class="text-center mb-6">
        <h1 class="text-4xl font-bold mb-2 text-green-400">Scan Absen Seminar & Workshop</h1>
    ...
    <script>
        ...
        async function sendQRCodeToServer(qrCodeValue) {
            try {
                const response = await fetch('process_absenseminar.php', {
                    method: 'POST',
