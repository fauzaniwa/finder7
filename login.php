...
<body class="bg-black">
  ...
  <section id="login" class="w-full h-auto md:h-screen flex lg:flex-row flex-col-reverse sm:p-8 sm:pt-28 items-center ">
    <div class="order-first lg:order-last relative z-10 lg:w-1/2 w-full h-1/2 md:h-2/3 lg:h-full text-start space-y-4 ">
      <form action="systemdata.php" method="POST"
        class="md:overflow-y-auto hide-scrollbar max-h-full items-center h-full w-full bg-white rounded-3xl rounded-b-none sm:rounded-b-3xl py-16 md:py-28">
        <div
    ...
    <div
      class="order-last lg:order-first lg:w-1/2 w-full h-1/2 lg:h-full mt-20 lg:mt-0 flex justify-center items-center">
