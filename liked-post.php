                            ...
                            <a href="detailpameran.php"
                                ...
                                <div
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <!-- Tombol Like -->
                                        <button
                                            class="like-button focus:outline-none transition-transform duration-200 hover:scale-110"
                                            aria-label="Suka karya ini">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                class="md:h-10 md:w-10 w-6 h-6 text-white transition-colors duration-200"
                                    ...
                                    <p class="text-xs md:text-sm">Lorem ipsum dolor sit amet consectetur adipisicing
                                        elit. Et at, eligendi dolor magnam cupiditate
