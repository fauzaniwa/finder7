...
<body class="bg-black pt-40">
    ...
    <div class="flex flex-col justify-center items-center pb-20">
        ...
        <div id="successModal"
            ...
            <div class="bg-emerald-400 text-black rounded-xl p-8 max-w-sm text-center shadow-lg">
                <h2 class="text-2xl font-bold mb-4">Pendaftaran berhasil dikirim!</h2>
        ...
        <div class="pb-10">
            <h1 class="font-bold text-3xl text-white">Formulir Pendaftaran Cosplay</h1>
        </div>

        <br>
        <div class="flex justify-center items-center py-12 px-5 bg-neutral-900 rounded-xl w-10/12 md:w-6/12">

            <form id="form" action="process_cosplay.php" method="post" class="flex flex-col gap-5 w-full">
    ...
    <div class="flex justify-center">
        <input type="text" id="karakter" name="Nama_Karakter" placeholder="Nama Karakter (contoh: Monkey D. Luffy - One Piece)" required
            class="rounded-lg pl-4 py-2 text-white bg-neutral-800 placeholder:text-neutral-700 w-full">
    </div>
    ...
    <div class="flex gap-5 justify-center">
        <input type="text" id="media-sosial" name="Media_Sosial" placeholder="Media Sosial" required
            class="rounded-lg pl-4 py-2 text-white bg-neutral-800 placeholder:text-neutral-700 w-full">
    </div>
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const closeDate = new Date("2025-09-15T23:59:59+07:00");
