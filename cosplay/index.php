...
<head>
    ...
    <title>Finder - Lomba Cosplay</title>
...
<body class="bg-black">
    ...
    <!-- Hero Section -->
    <section class="hero relative min-h-screen px-4 flex items-center justify-center md:w-full w-10/12 mx-auto overflow-hidden ">
        <!-- Top Left -->
        <img src="../img/Submission/supergraphic9.png" alt="Ilustrasi karakter dekoratif pojok kiri atas"
            class="absolute w-1/4 hidden lg:flex bottom-0 left-0  animate-pulse" />

        <!-- Top Right -->
        <img src="../img/Submission/supergraphic10.png" alt="Ilustrasi karakter dekoratif pojok kanan atas"
            class="absolute w-1/4 hidden lg:flex bottom-1/3 left- right-1/3 translate-x-[35%] translate-y-[30%] sm:translate-x-[100%] sm:translate-y-[-10%] animate-pulse" />

        <!-- Top Left -->
        <img src="../img/Submission/supergraphic8.png" alt="Ilustrasi karakter dekoratif pojok kiri atas"
            class="absolute hidden sm:flex bottom-40 right-0 w-1/6 animate-pulse " />

        <!-- Top Right -->
        <img src="../img/Submission/supergraphic7.png" alt="Ilustrasi karakter dekoratif pojok kanan atas"
            class="absolute hidden sm:flex top-24 left-0 w-1/6 animate-pulse" />



        <div class="w-full justify-center flex flex-col items-center max-w-2xl  mx-auto py-36 md:py-72 ">

            <h1 class="text-white text-3xl md:text-5xl font-semibold text-center"> Cosplay Competition</h1>
            <br><br>
            <div class="countdown flex justify-center gap-2 items-center mb-4">
                ...
                <div class="hidden md:flex separator text-white text-3xl md:text-5xl font-mono mb-6">:</div>
            ...
            <div class="flex flex-col md:flex-row w-full gap-5 mx-auto items-center justify-center pt-10 ">

                <a href="submitcosplay.php" class="w-full md:w-1/2">
                    <button
                        class="w-full submit-btn  bg-emerald-500 hover:bg-emerald-600 font-semibold transition-all duration-300 ease-in-out px-10 py-3 md:px-20 md:py-5 rounded-2xl md:rounded-3xl text-base md:text-xl text-black  ">Daftar</button>
                </a>
                <a href="#syarat" class="w-full md:w-1/2">
                    <button
                        class="w-full submit-btn  bg-white hover:bg-neutral-400 font-semibold transition-all duration-300 ease-in-out px-10 py-3 md:px-20 md:py-5 rounded-2xl md:rounded-3xl text-base md:text-xl text-black  ">Lihat
                        Ketentuan</button>
                </a>
            </div>
        </div>
    ...
    <!-- Deskripsi Section -->
    <section id="deskripsi" class="deskripsi relative md:py-[24rem] mx-auto overflow-hidden w-10/12 md:w-full">
        Kanan Atas
    ...
    <div class="flex justify-center items-center">
        ...
        <section class="timeline flex flex-col justify-center w-10/12 md:w-full mx-auto ">
            <h1 class="text-3xl md:text-6xl font-bold text-white text-center mb-16 md:mb-32">Timeline</h1>
            <img src="timelinecosplay.png" alt=""
                class="hidden sm:block w-10/12 justify-center mx-auto">
            <img src="timelinecosplay2.png" alt="" class="block sm:hidden w-full">
        </section>
    </div>
    <br><br><br><br><br><br><br><br>
    ...
    <section class="prize flex flex-col justify-center ">
        ...
        <div class="flex-col flex md:flex-row w-full h-auto justify-center text-white">
            <div class="flex flex-col w-full md:w-1/4 p-10">
                ...
                <div class="flex flex-col">
                    <h1 class=" mx-auto text-center italic font-semibold text-2xl pt-8 max-w-56">Rp.500.000,-</h1>
                    <p class="mx-auto max-w-56 text-center font-light text-xl "> +</p>
                    <p class="mx-auto max-w-56 text-center font-light text-xl ">Sertifikat Cetak</p>
                </div>
            </div>
            ...
            <div class="flex flex-row md:flex-col w-full md:w-1/4 p-10 items-center gap-4 md:gap-0">
                ...
                <div class="flex flex-col">
                    <h1 class=" mx-auto text-center italic font-semibold text-2xl pt-8 max-w-56">Rp.400.000,-</h1>
                    <p class="mx-auto max-w-56 text-center font-light text-xl ">+</p>
                    <p class="mx-auto max-w-56 text-center font-light text-xl ">Sertifikat Cetak</p>
                </div>
            </div>
            ...
            <div class="flex flex-row md:flex-col w-full md:w-1/4 p-10 items-center gap-4 md:gap-0">
                ...
                <div class="flex flex-col">
                    <h1 class=" mx-auto text-center italic font-semibold text-2xl pt-8 max-w-56"> Rp.300.000,-</h1>
                    <p class="mx-auto max-w-56 text-center font-light text-xl ">+</p>
                    <p class="mx-auto max-w-56 text-center font-light text-xl ">Sertifikat Cetak</p>
                </div>
            </div>
    ...
    <div class="relative">
        ...
        <section
            ...
            <div id="syarat"
                ...
                <h1 class="font-bold text-center text-2xl md:text-5xl mb-6 md:mb-10">Syarat Perlombaan</h1>
                <br><br><br><br>

                <ol
                    class="list-decimal list-outside pl-4 space-y-3 md:space-y-6 text-sm md:text-xl text-left md:text-justify">
                    <li>Lomba terbuka untuk umum 
                    </li>
                    <li>Peserta berkompetisi secara individu</li>
                    <li>Setiap peserta wajib mendaftar melalui website finderdkvupi.id yang telah disediakan </li>
                    <li>Kostum yang digunakan tidak mengandung unsur SARA, kekerasan, atau pornografi </a></li>
                    <li>Peserta wajib hadir tepat waktu sesuai jadwal yang ditentukan</li>
                    <li>Kompetisi ini tidak dipungut biaya apapun</li>
                </ol>

                <br><br><br>
                <h1 class="font-bold text-center text-2xl md:text-5xl mb-6 md:mb-10">Ketentuan Perlombaan</h1>
                <br><br><br><br>

                <ol
                    class="list-decimal list-outside pl-4 space-y-3 md:space-y-6 text-sm md:text-xl text-left md:text-justify">
                    <li>Peserta diperbolehkan menampilkan kostum yang diambil dari referensi apapun
                    </li>
                    <li>Peserta diperbolehkan menggunakan kostum hasil kreasi sendiri atau modifikasi </li>
                    <li>Kostum harus aman dan tidak membahayakan peserta maupun penonton  </li>
                    <li>Kostum tidak boleh menggunakan bahan yang dapat merusak properti di lokasi acara </a></li>
                    <li>Peserta diperbolehkan menempilkan kostum yang diambil dari berbagai referensi, selama tidak
                        mengandung unsur SARA, politik, kekerasan, maupun pornografi. </li>
                </ol>
            </div>
            ...
            <div id="teknis"
                ...
                <ol
                    class="list-decimal list-outside pl-4 space-y-3 md:space-y-6 text-sm md:text-xl text-left md:text-justify">
                    <li>Peserta wajib mengikuti technical meeting yang akan dilaksanakan pada 15 September 2025 secara
                        online (undangan digital akan dikirim menyusul)
                    </li>
                    <li>Peserta diperbolehkan datang ke Gd. FPSD Baru UPI dimulai dari pukul 14.00 WIB</li>
                    <li>Peserta akan dipersilakan oleh MC untuk melakukan coswalk di Lapang Bundar Gd. FPSD Baru UPI
                        pada pukul 15.00 WIB sesuai dengan urutan nomor peserta</li>
                    <li>Pengumuman akan dilaksanakan secara langsung pada pukul 17.40 WIB</li>
                </ol>
                ...
                <ol
                    class="list-decimal list-outside pl-4 space-y-3 md:space-y-6 text-sm md:text-xl text-left md:text-justify">
                    <li>Kreativitas dan detail kostum
                    </li>
                    <li>Kualitas eksekusi </li>
                    <li>Performa saat penampilan </li>
                </ol>
                <br><br><br>
            </div>
        </section>
    ...
    <div class="flex flex-col items-center justify-center gap-6">\
        <a href="submitcosplay.php">
            <button
                class="submit-btn items-center bg-emerald-600 hover:bg-emerald-800 transition-all duration-300 ease-in-out px-10 py-3 md:px-20 md:py-5 rounded-2xl md:rounded-3xl mt-6 text-base md:text-xl text-black font-semibold">Daftar</button>
        </a>
    </div>
    <br><br><br><br><br><br>
